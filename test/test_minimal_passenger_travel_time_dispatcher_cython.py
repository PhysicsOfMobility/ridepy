...
from ridepy.util.dispatchers_cython import (
    MinimalPassengerTravelTimeDispatcher as CMinimalPassengerTravelTimeDispatcher,
)
...
def test_equivalence_cython_and_python_minimal_passenger_travel_time_dispatcher(
    ...
    """
    Tests that the pure pythonic and cythonic minimal passenger travel time dispatcher produces identical results.
    """
    len_stoplist = 100
    seat_capacity = 4
    ...
    pythonic_solution = MinimalPassengerTravelTimeDispatcher()(
    ...
    # CyMinimalPassengerTravelTimeDispatcher
    ...
    cythonic_solution = CyMinimalPassengerTravelTimeDispatcher(LocType.R2LOC)(
        request, stoplist, space, seat_capacity
    )
...
def test_equivalence_simulator_cython_and_python_minimal_passenger_travel_time_dispatcher(
    ...
    for py_space, cy_space in (
        ...
        ssfs = SlowSimpleFleetState(
            ...
            seat_capacities=10,
            space=cy_space,
            dispatcher=CMinimalPassengerTravelTimeDispatcher(
...
def test_sanity_in_graph():
    ...
    for velocity in [0.9, 1, 1.1]:
        ...
        fs = SlowSimpleFleetState(
            ...
            seat_capacities=10,
            space=space,
            dispatcher=CMinimalPassengerTravelTimeDispatcher(LocType.INT),
            vehicle_state_class=cy_VehicleState,
        )
